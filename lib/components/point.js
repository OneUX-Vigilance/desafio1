    ...
    if (user.name) {
        ...
        return (
            <section className="center" style={{ width: "80vw", textAlign: "center" }}>
                ...
                <p className ="loginInfo" onClick={() => setRegister(!isRegister)} style={{cursor: "pointer",}}>{isRegister ? 'Ja tem uma conta? clique aqui para fazer login' : 'Clique aqui para se registrar'}</p>
            </section>
        )
    }
}